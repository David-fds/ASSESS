...
if(isFavorite == true){
    console.log("My favority food is " + food);
}
else{
...
var vegetables = ["onions", "potatoes", "celery", "green peppers", "carrots"];
...
var fruits = ["apples", "oranges", "pears", "grapes", "berries", "lemons", "grapefruit"];
